...
class SettingsPageState extends State<SettingsPage> {
  ...
  final FocusNode focusNodeSchoolNum = FocusNode();
  final FocusNode focusNodeJob = FocusNode();
  ...
  void readLocal() {
    setState(() {
      ...
      schoolNum = settingProvider.getPref(FirestoreConstants.schoolNum) ?? "";
      job = settingProvider.getPref(FirestoreConstants.job) ?? "";
    });

    controllerNickname = TextEditingController(text: nickname);
    controllerAboutMe = TextEditingController(text: aboutMe);
    controllerSchoolNum = TextEditingController(text: schoolNum);
    controllerJob = TextEditingController(text: job);
  }
  ...
  void handleUpdateData() {
    ...
    settingProvider
      ...
      await settingProvider.setPref(FirestoreConstants.photoUrl, photoUrl);
      await settingProvider.setPref(FirestoreConstants.schoolNum, schoolNum);
      await settingProvider.setPref(FirestoreConstants.job, job);
                    ...
                    Container(
                      child: Theme(
                        ...
                        child: TextField(
                          ...
                          controller: controllerSchoolNum,
                          onChanged: (value) {
                            schoolNum = value;
                          },
                          focusNode: focusNodeSchoolNum,
                        ),
                      ),
                      margin: EdgeInsets.only(left: 30, right: 30),
                    ),
